      ...
      <div className="bg-card rounded-lg border border-border p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex gap-1">
            ...
            <button className="text-[10px] px-2 py-0.5 rounded-full bg-primary text-primary-foreground">Day</button>
          </div>
        </div>
        ...
        <button className="w-full mt-2 text-sm text-link hover:underline text-center">
          See all
        </button>
      </div>
    </div>
